<template>
  <main>
    <div class="wrapper">
      <!--<div id="loader"></div>    LOADER GIF TO BE RE-ENABLED WITH JS FILE--> 
        ...
        <section class="sidebar">	
          <div class="user-profile px-20 pt-15 pb-10">
            <div class="d-flex align-items-center">			
              <div class="image">
              <img src="../static/images/avatar/avatar-13.png" class="avatar avatar-lg bg-primary-light rounded100" alt="User Image">
              </div>
              <div class="info">
          ...
          <ul class="sidebar-menu" data-widget="tree">		
            ...
            <li>
            <a href="billing.html">
              <i class="icon-Credit-card"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
              <span>Billing</span>
            </a>
            </li>
            <li>
            ...
            <ul class="treeview-menu">
              ...
              <li class="treeview">
                <a href="#">
                  <i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Authentication
                  <span class="pull-right-container">
                    <i class="fa fa-angle-right pull-right"></i>
                  </span>
                </a>
              ...
              <li class="treeview">
                <a href="#">
                  <i class="icon-Commit"><span class="path1"></span><span class="path2"></span></i>Miscellaneous
                  <span class="pull-right-container">
                    <i class="fa fa-angle-right pull-right"></i>
                  </span>
                </a>
            ...
            <div class="row">
              <div class="col-xl-9 col-12">
                <div class="row">
                  ...
                  <div class="col-xxxl-4 col-xl-5 col-12">
                    <div class="box">
                      <div class="box-header">
                        <h4 class="box-title">Total Inventory </h4>
                      </div>
                      <div class="box-body">
                    ...
                    <div class="box">
                      ...
                      <div class="box-body">
                        <div class="d-flex align-items-center mb-30">
                          <div class="mr-15">
                            <img src="../static/images/avatar/avatar-1.png" class="avatar avatar-lg rounded100 bg-primary-light" alt="" />
                          </div>
                        ...
                        <div class="d-flex align-items-center mb-30">
                          <div class="mr-15">
                            <img src="../static/images/avatar/avatar-10.png" class="avatar avatar-lg rounded100 bg-primary-light" alt="" />
                          </div>
                          <div class="d-flex flex-column flex-grow-1 font-weight-500">
                        ...
                        <div class="d-flex align-items-center mb-30">
                          <div class="mr-15">
                            <img src="../static/images/avatar/avatar-11.png" class="avatar avatar-lg rounded100 bg-primary-light" alt="" />
                          </div>
                          <div class="d-flex flex-column flex-grow-1 font-weight-500">
                        ...
                        <div class="d-flex align-items-center">
                          <div class="mr-15">
                            <img src="../static/images/avatar/avatar-12.png" class="avatar avatar-lg rounded100 bg-primary-light" alt="" />
                          </div>
                          <div class="d-flex flex-column flex-grow-1 font-weight-500">
              ...
              <div class="box box-inverse box-info">
                ...
                <a class="avatar float-left mr-20" href="javascript:void(0)">
                  <img src="../static/images/avatar/5.jpg" alt="">
                </a>
                <div>
      ...
      <footer class="main-footer">
        ...
        &copy; 2020 <a href="beuva.com">Beuva</a>. All Rights Reserved.
      </footer>
      <!-- Control Sidebar -->
        ...
        <div class="tab-content">
            ...
            <div class="media-list media-list-hover mt-20">
              ...
              <div class="media py-10 px-0">
                <a class="avatar avatar-lg status-primary" href="#">
                  <img src="../static/images/avatar/4.jpg" alt="...">
                </a>
                <div class="media-body">
                  <p class="font-size-16">
                  <a class="hover-primary" href="#"><strong>Evan</strong></a>
          ...
          <div class="tab-pane" id="control-sidebar-settings-tab">
            <div class="flexbox">
              ...
              <p>Todo List</p>
              <a href="#" class="text-right text-grey"><i class="ti-plus"></i></a>
            </div>
                  ...
                  <div class="chat-logs">
                      <div class="chat-msg user">
                          <div class="d-flex align-items-center">
                              <span class="msg-avatar">
                                  <img src="../static/images/avatar/2.jpg" class="avatar avatar-lg">
                              </span>
                              <div class="mx-10">
                      ...
                      <div class="chat-msg self">
                          <div class="d-flex align-items-center justify-content-end">
                              ...
                              <span class="msg-avatar">
                                  <img src="../static/images/avatar/3.jpg" class="avatar avatar-lg">
                              </span>
                          </div>
                          <div class="cm-msg-text">
