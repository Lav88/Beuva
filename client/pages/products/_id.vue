                                        ...
                                        <div class="zoompro-wrap product-zoom-right pl-20">
                                            ...
                                            <div class="product-buttons">
                                                ...
                                                <a href="#" class="btn prlightbox" title="Zoom">
                                                    <i class="icon anm anm-expand-l-arrows" aria-hidden="true"></i> <span class="tooltip-label">Zoom Image</span>
                                                </a>
                                                <a href="#threesixty" class="btn pr360view"><i class="anm anm-repeat-r"></i> <span class="tooltip-label">360 Product View</span></a>
                                            </div>
                                        </div>
                                ...
                                <form method="post" action="/cart/add" id="product_form_10508262282" accept-charset="UTF-8" class="product-form product-form-product-template hidedropdown" enctype="multipart/form-data">
                                    <div class="swatch clearfix swatch-0 option1" data-option-index="0">
                                        ...
                                        <div data-value="Red" class="swatch-element color red available">
                                            ...
                                            <label class="swatchLbl color medium" for="swatch-0-red" style="background-image:url(assets/images/product-images/50x50.jpg);" title="Red"></label>
                                        </div>
                                        <div data-value="Blue" class="swatch-element color blue available">
                                            <input class="swatchInput" id="swatch-0-blue" type="radio" name="option-0" value="Blue">
                                            <label class="swatchLbl color medium" for="swatch-0-blue" style="background-image:url(assets/images/product-images/50x50.jpg);" title="Blue"></label>
                                        </div>
                                        <div data-value="Green" class="swatch-element color green available">
                                            <input class="swatchInput" id="swatch-0-green" type="radio" name="option-0" value="Green">
                                            <label class="swatchLbl color medium" for="swatch-0-green" style="background-image:url(assets/images/product-images/50x50.jpg);" title="Green"></label>
                                        </div>
                                        <div data-value="Gray" class="swatch-element color gray available">
                                            <input class="swatchInput" id="swatch-0-gray" type="radio" name="option-0" value="Gray">
                                            <label class="swatchLbl color medium" for="swatch-0-gray" style="background-image:url(assets/images/product-images/50x50.jpg);" title="Gray"></label>
                                        </div>
                                        <div data-value="aqua" class="swatch-element color aqua available">
                                            ...
                                            <label class="swatchLbl color medium" for="swatch-0-aqua" style="background-image:url(assets/images/product-images/50x50.jpg);" title="aqua"></label>
                                        </div>
                                        <div data-value="Orange" class="swatch-element color orange available">
                                            <input class="swatchInput" id="swatch-0-orange" type="radio" name="option-0" value="Orange">
                                            <label class="swatchLbl color medium" for="swatch-0-orange" style="background-image:url(assets/images/product-images/50x50.jpg);" title="Orange"></label>
                                        </div>
                                        </div>
                                    </div>
